<apply template=_layout>
  ...
  function-name</i><code>(</code><i>parameter-list,...</i><code>)
  {</code> <i>body...</i> <code>}</code></blockquote>
...
int joe(float coin, double total, int sum)   
  ...
  <blockquote><code>int main(void) {</code> <i>body...</i>
  <code>}</code></blockquote>
  Or with the following two parameters:
  <blockquote><code>int main(int argc, char *argv[]) {</code>
  <i>body...</i> <code>}</code></blockquote>
